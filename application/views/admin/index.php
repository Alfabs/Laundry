                        ...
                        <div class="col-xl-3 col-md-6 mb-4">
                            <div class="card border-left-warning shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">Sedang Proses
                                            </div>
                                            <div class="row no-gutters align-items-center">
                                                <div class="col-auto">
					...
					<ul class="pagination justify-content-center mt-3">
						<?php if ($pagination_transaksi['total_pages'] > 1): ?>
							<?php if ($pagination_transaksi['current_page'] > 1): ?>
								<li class="page-item">
									<a class="page-link" href="<?= base_url('admin?page=' . ($pagination_transaksi['current_page'] - 1)); ?>">
							...
							<?php for ($i = 1; $i <= $pagination_transaksi['total_pages']; $i++): ?>
								<li class="page-item <?= ($i == $pagination_transaksi['current_page']) ? 'active' : ''; ?>">
									<a class="page-link" href="<?= base_url('admin?page=' . $i); ?>">
										<?= $i; ?>
									</a>
								</li>
							<?php endfor; ?>
