                ...
                <div class="container-fluid">
					...
					<div class="row">
						<div class="col-lg-6">
						<?= form_error('menu', '<div class="alert alert-danger col-lg-8" role="alert">', '</div>'); ?>
						...
						<a class="btn btn-primary mb-3"  href="" data-toggle="modal" data-target="#newMenuModal">Add New Menu</a>
							...
							<tbody>
								...
								<tr>
									...
									<td><?= $options['menu'];?></td>
									<td>
										<a class="badge badge-success" href="<?= base_url('');?>menu/edit/<?= $options['id'];?>">Edit</a>
										<a onclick="return confirm('This Menu Data will be removed Permanently\nAre you sure?');" class="badge badge-danger" href="<?= base_url('');?>menu/delete/<?= $options['id'];?>">Delete</a>
									</td>
								</tr>
								<?php endforeach;?>
							</tbody>
