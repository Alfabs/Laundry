                ...
                <div class="container-fluid">
					...
					<a href="<?= base_url('pelanggan/tambahPelanggan');?>" class="mb-4 btn btn-primary">Tambah Pelanggan</a>
							...
							<tbody>
								...
								<tr>
									...
									<td class="text-center">
										<a class="badge badge-success" href="<?= base_url('');?>pelanggan/editPelanggan/<?= $customer['id'];?>">Edit</a>
								...
								<ul class="pagination justify-content-center mt-3">
									<?php if ($pagination['total_pages'] > 1): ?>
										...
										<?php if ($pagination['current_page'] > 1): ?>
											<li class="page-item">
												<a class="page-link" href="<?= base_url('pelanggan?page=' . ($pagination['current_page'] - 1)); ?>">
										...
										<?php for ($i = $start_page; $i <= $end_page; $i++): ?>
											<li class="page-item <?= ($i == $pagination['current_page']) ? 'active' : ''; ?>">
												<a class="page-link" href="<?= base_url('pelanggan?page=' . $i); ?>">
													<?= $i; ?>
												</a>
											</li>
										<?php endfor; ?>
